...
class HintDialogFragment : DialogFragment() {
    companion object {
        ...
        fun newInstance(terms: Array<Term>): HintDialogFragment =
            HintDialogFragment().apply { arguments = Bundle().apply { putSerializable(TERMS, terms) } }
    }
